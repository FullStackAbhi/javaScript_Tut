...
// Destructuring also works well with complex functions that have a lot of parameters,
...
//  However, the array itself is not modified.
...
let [firstName = 'divya', surname = 'jjjjjj'] = [];
...
// for instance, make options.width go into the variable named w, then we can set the variable name using a colon:
...
//  It may have a width, a height, a title, an item list and so on.
...
showMenu(options)
// In real-life, the problem is how to remember the order of arguments. Usually, 
// IDEs try to help us, especially if the code is well-documented, but still… Another problem is how to call a function
