...
// The major difference between a real-life ask and the example above is that real-life functions
//  use more complex ways to interact with the user than a simple confirm. In the browser,
//  such functions usually draw a nice-looking question window. But that’s another story.
...
// as it’s easier to look up function f(…) {…} in the code than let f = function(…) {…};. 
